    ...
    def _ensure_bucket_exists(self):
        try:
            ...
            try:
                ...
                print(f"Warning: Could not ensure bucket exists: {inner_e}")
                # We don't raise here to allow test collection to proceed
                # and fail only when actual storage access is needed
